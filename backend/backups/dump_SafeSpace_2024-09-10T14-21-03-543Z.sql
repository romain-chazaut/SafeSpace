...
--
-- Name: COLUMN backup.name_database; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.backup.name_database IS 'Nom de la base de données sauvegardée';
...
1	/path/to/backup1.sql	2024-09-10 09:30:01.797115+00	create	nom_par_defaut
2	/path/to/backup2.sql	2024-09-10 09:30:01.797115+00	restore	nom_par_defaut
\.
...
--
-- Name: idx_backup_name_database; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_backup_name_database ON public.backup USING btree (name_database);
